...
INSERT INTO CINEMA(NAME) VALUES('Мираж1');
INSERT INTO CINEMA(NAME) VALUES('РИО');
INSERT INTO CINEMA(NAME) VALUES('Мираж2');
COMMIT;
...
COMMIT;
INSERT INTO FILMSESSION(REFHALL, NAME, START, DATEEND) VALUES(1, 'Фильм 1', CURRENT_TIMESTAMP + interval '1h' * 2, CURRENT_TIMESTAMP + interval '1h' * 3);
INSERT INTO FILMSESSION(REFHALL, NAME, START, DATEEND) VALUES(1, 'Фильм 2', CURRENT_TIMESTAMP + interval '1h' * 2, CURRENT_TIMESTAMP + interval '1h' * 3);
INSERT INTO FILMSESSION(REFHALL, NAME, START, DATEEND) VALUES(1, 'Фильм 3', CURRENT_TIMESTAMP + interval '1h' * 2, CURRENT_TIMESTAMP + interval '1h' * 3);
INSERT INTO FILMSESSION(REFHALL, NAME, START, DATEEND) VALUES(2,'Фильм 4', CURRENT_TIMESTAMP + interval '1h' * 2, CURRENT_TIMESTAMP + interval '1h' * 3);
INSERT INTO FILMSESSION(REFHALL, NAME, START, DATEEND) VALUES(2,'Фильм 5', CURRENT_TIMESTAMP + interval '1h' * 1, CURRENT_TIMESTAMP + interval '1h' * 2);
INSERT INTO FILMSESSION(REFHALL, NAME, START, DATEEND) VALUES(2,'Фильм 6',  CURRENT_TIMESTAMP + interval '1h' * 1, CURRENT_TIMESTAMP + interval '1h' * 2);
INSERT INTO FILMSESSION(REFHALL, NAME, START, DATEEND) VALUES(5,'Фильм 7', CURRENT_TIMESTAMP + interval '1h' * 2, CURRENT_TIMESTAMP + interval '1h' * 3);
INSERT INTO FILMSESSION(REFHALL, NAME, START, DATEEND) VALUES(5,'Фильм 8',  CURRENT_TIMESTAMP + interval '1h' * -2, CURRENT_TIMESTAMP + interval '1h' * -1);
COMMIT;
